---
title: Glossary
description: Canonical terminology used across ARAF specification, certification, assessment, and evidence documents.
---

## Specification Reference

This glossary defines terms used across the ARAF standard specification, the Six Dimensions assessment model, the Governance Benchmark Index, certification materials, and the Decision Supply Chain framework. Definitions are stated consistently with usage in *[Trust Architecture](/trust-architecture/): Making Autonomous Systems Bankable* by Carly Martin (forthcoming). Where a term carries a specific technical meaning within the ARAF framework, that meaning governs over any general usage.
