...
<main id="top" className="standard-page governance-page">
    <div className="container container--reading">
      ...
      <p>The ARAF standard is maintained by Institute for Autonomous Governance Pty Ltd as a public standard licensed under Creative Commons Attribution 4.0 (CC BY 4.0).</p>
