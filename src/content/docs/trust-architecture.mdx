...
description: The trust architecture required for institutional reliance on autonomous systems.
canonical: /docs/trust-architecture/
...
ARAF defines the trust architecture that enables institutions to rely on autonomous system outputs for consequential decisions.
...
![Engineering telemetry versus governance telemetry — ARAF evidence distinction](/images/araf/araf_engineering_vs_governance_telemetry.svg)
...
![Decision Supply Chain accountability ownership — five stages from data inputs to institutional exposure](/images/araf/araf_dsc_ownership_overlay.svg)
